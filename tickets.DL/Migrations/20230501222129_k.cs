    ...
    public partial class k : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "ticket discription", "ticket title" },
                    { 2, 0, "ticket discription", "ticket title" },
                    { 3, 0, "ticket discription", "ticket title" },
                    { 4, 0, "ticket discription", "ticket title" },
                    { 5, 0, "ticket discription", "ticket title" }
                });
